/**
* The FuelTankTester class is designed to use the private instance variables in the classes 
*created in the Car.java file and then calls the methods in the appropriate
*place to print the output in the required format.
* @author : Rishi Villa	
* Collaborators: None 
